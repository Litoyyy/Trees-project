...
class SiteSettings(models.Model):
    ...
    banner_text = models.CharField(max_length=256, verbose_name="Текст в баннере на главной", blank=True)
...
class Partnership(models.Model):
    ...
    button_text = models.CharField(max_length=64, verbose_name="Текст в кнопке", blank=True)
    image = models.ImageField(upload_to="partnership/images", verbose_name="Изображение", blank=True)
